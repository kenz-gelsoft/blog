...
image: "/images/2026-05-16-all-cosmic-apps-support-ime-soon/cosmic-term1.png"
published: true
---

[COSMICデスクトップの日本語入力対応状況(2026/05)](/posts/2026-05-09-cosmic-ja-status#cosmicアプリ)で唯一未対応としていた[COSMIC端末固有のIME対応](https://github.com/pop-os/cosmic-term/pull/753)がマージされました。COSMIC Epoch 1.0.14で今月中にはリリースされる見込みです。

つぎの画面のように`cosmic-term`のターミナル画面上で日本語入力ができるようになりました。

![](/images/2026-05-16-all-cosmic-apps-support-ime-soon/cosmic-term1.png)
...
![](/images/2026-05-16-all-cosmic-apps-support-ime-soon/cosmic-term2.png)
...
![](/images/2026-05-16-all-cosmic-apps-support-ime-soon/cosmic-term3.png)

ターミナル画面でIME入力のテキストを確定した後、一時的に確定テキストが選択表示で残る動作がありますが、これは現状では意図したものです。System76が変更を受け入れやすくするため、IME利用に必要不可欠な対応のみをしています。

![](/images/2026-05-16-all-cosmic-apps-support-ime-soon/cosmic-term4.png)
